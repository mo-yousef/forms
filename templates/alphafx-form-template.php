<form class="fxc-form" method="post" enctype="multipart/form-data" novalidate>
    <input type="hidden" name="form_type" value="alphafx_academy" data-save-field="true">
    ...
    <div class="fxc-form-wrapper">
        <div class="form-grid-wrapper">
            ...
            <div class="form-input-wrapper">
                <label for="first_name"><?php echo _x('First Name', 'Alpha FX form Content', 'fxc'); ?></label>
            ...
            <!-- Last Name -->
            <div class="form-input-wrapper">
                <label for="last_name"><?php echo _x('Last Name', 'Alpha FX form Content', 'fxc'); ?></label>
        ...
        <!-- Email -->
        <div class="form-input-wrapper">
            <label for="email"><?php echo _x('Email', 'Alpha FX form Content', 'fxc'); ?></label>
        ...
        <!-- Country Dropdown -->
        <div class="form-input-wrapper">
            <label for="country"><?php echo _x('Country of residence', 'Alpha FX form Content', 'fxc'); ?></label>
        ...
        <!-- Phone Number -->
        <div class="form-input-wrapper">
            <label for="phone_number"><?php echo _x('Phone Number', 'Alpha FX form Content', 'fxc'); ?></label>
        ...
        <!-- Comment (Message) -->
        <div class="form-input-wrapper">
            <label for="message"><?php echo _x('Comment', 'Alpha FX form Content', 'fxc'); ?></label>
            <textarea id="message" name="message" data-save-field="true" data-ac="message" maxlength="500"
                rows="1"></textarea>
        ...
        <div class="form-input-wrapper">
            <label>
                ...
                <p> <?php _e('I have read and agree to the ', 'fxc'); ?><a
                        href="/wp-content/themes/fxc/inc/assets/pdf/4XC-Terms-Conditions.pdf"
                        target="_blank"><?php echo _x('Terms & Conditions.', 'Alpha FX form Content', 'fxc'); ?></a>
                </p>
            </label>
        ...
        <div class="form-input-wrapper">
            <button type="submit"
                class="button button-primary"><?php echo _x('GET IN TOUCH', 'Alpha FX form Content', 'fxc'); ?></button>
        </div>

        <div class="form-notes-section">
            <p><?php echo _x('By continuing you agree to our ', 'Alpha FX form Content', 'fxc'); ?> <a
                    href="/wp-content/themes/fxc/inc/assets/pdf/4XC-Privacy-Policy.pdf"
                    target="_blank"><?php echo _x('Privacy Policy.', 'Alpha FX form Content', 'fxc'); ?></a></p>
        </div>
    </div>
</form>
