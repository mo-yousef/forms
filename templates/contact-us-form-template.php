<form class="fxc-form" method="post" enctype="multipart/form-data" novalidate>
    <input type="hidden" name="form_type" value="contact_us" data-save-field="true">
    ...
    <div class="fxc-form-wrapper">
        <div class="form-grid-wrapper">
            ...
            <div class="form-input-wrapper">
                <label for="first_name"><?php echo _x('First Name', 'Contact Us Form Content', 'fxc'); ?></label>
            ...
            <!-- Last Name -->
            <div class="form-input-wrapper">
                <label for="last_name"><?php echo _x('Last Name', 'Contact Us Form Content', 'fxc'); ?></label>
        ...
        <!-- Email -->
        <div class="form-input-wrapper">
            <label for="email"><?php echo _x('Email', 'Contact Us Form Content', 'fxc'); ?></label>
        ...
        <!-- Country Dropdown -->
        <div class="form-input-wrapper">
            <label for="country"><?php echo _x('Country', 'Contact Us Form Content', 'fxc'); ?></label>
        ...
        <!-- Phone Number -->
        <div class="form-input-wrapper">
            <label for="phone_number"><?php echo _x('Phone Number', 'Contact Us Form Content', 'fxc'); ?></label>
        ...
        <!-- Subject -->
        <div class="form-input-wrapper">
            <label for="subject"><?php echo _x('Subject', 'Contact Us Form Content', 'fxc'); ?></label>
            <input type="text" id="subject" name="subject" data-save-field="true" required />
            <span class="error-message" id="subject_error"></span>
        </div>

        <!-- Message -->
        <div class="form-input-wrapper">
            <label for="message"><?php echo _x('Message', 'Contact Us Form Content', 'fxc'); ?></label>
            <textarea id="message" name="message" data-save-field="true" data-ac="message" maxlength="1000"
        ...
        <div class="form-input-wrapper">
            <label>
                ...
                <p> <?php _e('I have read and agree to the ', 'fxc'); ?>
                        href="/wp-content/themes/fxc/inc/assets/pdf/4XC-Terms-Conditions.pdf"
                        target="_blank"><?php echo _x('Terms & Conditions.', 'Contact Us Form Content', 'fxc'); ?></a>
                </p>
            </label>
        ...
        <div class="form-input-wrapper">
            <button type="submit"
                class="button button-primary"><?php echo _x('SEND MESSAGE', 'Contact Us Form Content', 'fxc'); ?></button>
        </div>

        <div class="form-notes-section">
            <p><?php echo _x('By continuing you agree to our ', 'Contact Us Form Content', 'fxc'); ?> 
                    href="/wp-content/themes/fxc/inc/assets/pdf/4XC-Privacy-Policy.pdf"
                    target="_blank"><?php echo _x('Privacy Policy.', 'Contact Us Form Content', 'fxc'); ?></a></p>
        </div>
    </div>
</form>
