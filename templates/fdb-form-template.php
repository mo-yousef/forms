<?php
/**
 * Template for the First Deposit Bonus Form (FDB).
 * 
 * Required fields:
 *  - fdb_first_name
 *  - fdb_last_name
 *  - fdb_email (triggers API call to fetch country)
 *  - fdb_country (readonly, populated by API)
 *
 * Trading accounts removed. Submit is disabled until fields are valid.
 */
?>
<form class="fxc-fdb-form" id="myForm" action="#" method="post" novalidate>
    <input type="hidden" name="form_type" value="bonus_request">
    ...
    <div class="fxc-form-wrapper">
        ...
        <div class="form-input-wrapper">
            <label for="fdb_country"><?php echo _x('Country', 'FDB Form Content', 'fxc'); ?></label>
            <input id="fdb_country" name="fdb_country" data-ac="country" type="text" readonly />
            <span class="error-message" id="fdb_country_error"></span>
        </div>

        <div class="form-small-grid-wrapper">
            <div class="form-input-wrapper">
                <label for="trading_platform"><?php _e('Trading Platform', 'fxc'); ?></label>
            ...
            <div class="form-input-wrapper">
                <label
                    for="mt_account_number"><?php echo _x('Trading Account number', 'FDB Form Content', 'fxc'); ?></label>
        ...
        <div class="form-input-wrapper">
            <label>
                ...
                <p><?php _e('I have read and agree to the', 'fxc'); ?>
                    <a href="/wp-content/themes/fxc/inc/assets/pdf/first-deposit-bonus-terms-conditions.pdf"
                        target="_blank">
        ...
        <div class="form-input-wrapper">
            ...
            <button id="fdb_submit_button" class="button button-primary" type="submit"
                disabled><?php echo _x('REQUEST BONUS', 'FDB Form Content', 'fxc'); ?></button>
        </div>
        ...
        <div class="form-notes-section">
            ...
            <p>
                <?php echo _x('Max bonus is 1000 USD/GBP/EUR or 5000BRL.', 'FDB Form Content', 'fxc'); ?>
            </p>
        </div>
    </div>
</form>
