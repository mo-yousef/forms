...
<form class="fxc-form fxc-form-wrapper" method="post" enctype="multipart/form-data" novalidate>
    ...
    <div class="form-input-wrapper">
        ...
        <input type="email" id="email" name="email" data-ac="email" value="mappingtest2@example.com" required />
    </div>
    ...
    <div class="form-input-wrapper">
        ...
        <div class="phone-input-container" style="display: flex; align-items: center; position: relative;">
            ...
            <input type="tel" id="phone_number" class="disable-input-style" name="phone_number" data-save-field="true"
                pattern="^[0-9\-\(\)\s]{7,15}$" pattern="^\+?[0-9\-\(\)\s]{7,15}$"
    ...
    <div class="form-small-grid-wrapper">
        ...
        <div class="form-input-wrapper">
            ...
            <select id="trading_platform" name="trading_platform" data-ac="tradingPlatform" required>
                <!-- <option value=""><?php _e('', 'fxc'); ?></option> -->
        ...
        <div class="form-input-wrapper">
            <label for="mt_account_number">Trading Account Number</label>
