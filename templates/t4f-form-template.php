<form class="fxc-form" method="post" enctype="multipart/form-data" novalidate>
    <input type="hidden" name="form_type" value="t4f_academy" data-save-field="true">
    ...
    <div class="fxc-form-wrapper">
        <div class="form-grid-wrapper">
            ...
            <div class="form-input-wrapper">
                <label for="first_name"><?php echo _x('First Name', 'T4F Form Content', 'fxc'); ?></label>
            ...
            <!-- Last Name -->
            <div class="form-input-wrapper">
                <label for="last_name"><?php echo _x('Last Name', 'T4F Form Content', 'fxc'); ?></label>
        ...
        <!-- Email -->
        <div class="form-input-wrapper">
            <label for="email"><?php echo _x('Email', 'T4F Form Content', 'fxc'); ?></label>
        ...
        <!-- Country Dropdown -->
        <div class="form-input-wrapper">
            <label for="country"><?php echo _x('Country of residence', 'T4F Form Content', 'fxc'); ?></label>
        ...
        <!-- Phone Number -->
        <div class="form-input-wrapper">
            <label for="phone_number"><?php echo _x('Phone Number', 'T4F Form Content', 'fxc'); ?></label>
        ...
        <!-- Comment (Message) -->
        <div class="form-input-wrapper">
            <label for="message"><?php echo _x('Comment', 'T4F Form Content', 'fxc'); ?></label>
        ...
        <div class="form-input-wrapper">
            <label>
                ...
                <p> <?php _e('I have read and agree to the ', 'fxc'); ?><a
                        ...
                        target="_blank"><?php echo sprintf(_x('Terms & Conditions. ', 'T4F Form Content', 'fxc'), '<span class="desktop-hide-break"><br></span>'); ?></a>
                </p>
            </label>
        ...
        <div class="form-input-wrapper">
            <button type="submit"
                class="button button-primary"><?php echo _x('GET IN TOUCH', 'T4F Form Content', 'fxc'); ?></button>
        </div>

        <div class="form-notes-section">
            <p><?php echo _x('By continuing you agree to our ', 'T4F Form Content', 'fxc'); ?> <a
                    href="/wp-content/themes/fxc/inc/assets/pdf/4XC-Privacy-Policy.pdf"
                    target="_blank"><?php echo _x('Privacy Policy.', 'T4F Form Content', 'fxc'); ?></a></p>
        </div>
    </div>
</form>
